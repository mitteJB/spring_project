...
<%--        <h4 style="font-size: 25px;">Bom Air에 오신 것을 환영합니다!</h4>--%>
        ...
        <div id="id_myModal" class="modal">
            ...
            <div class="modal-content" style="width: 50%; margin-top: 230px; margin-left: 450px">
                ...
                <p style="text-align: center; line-height: 1.5;"><span style="font-size: 14pt;">이름: <input
                        id="find_name" placeholder="이름"/></span></p>
        ...
        <div id="pwd_myModal" class="modal">
            ...
            <div class="modal-content" style="width: 50%; margin-top: 230px; margin-left: 450px">
                ...
                <p style="text-align: center; line-height: 1.5;"><span style="font-size: 14pt;">이름: <input
                        id="find_pwd_name" placeholder="이름"/></span></p>
                <p style="text-align: center; line-height: 1.5;"><span style="font-size: 14pt;">휴대전화: 
                ...
                <p style="text-align: center; line-height: 1.5;"><span style="font-size: 14pt;">ID: <input
                        id="find_pwd_id" placeholder="ID"/></span></p>
                <p><br/></p>
                <p style="text-align: center; line-height: 1.5;"><br/></p>
                <p style="text-align: center; line-height: 1.5;">
                    <button class="btn btn-primary btn-lg" id="pwd_find">비밀번호 찾기</button>
                </p>
                <div style="cursor:pointer;background-color:#DDDDDD;text-align: center;padding-bottom: 10px;padding-top: 10px;"
                     onClick="close_pop();">
                <span class="pop_bt" style="font-size: 13pt;">
