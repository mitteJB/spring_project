	...
	<div class="container">
		<form action="register" method="post" onsubmit="return check();">
			...
			<div class="row setup-content" id="step-1">
				<h1 align="center" style="padding:10px 0 0 0; font-size:40px; font-family: 'Italianno', cursive;">JUn Do Young Airline</h1>
				<h2 align="center" style="font-weight:bolder; font-size:40px;">주디에어와 함께 하시는 길</h2>
				<br><br><br><br><br>
...
▶ 주디에어클럽 개인 정보 수집 및 이용 안내

[개인정보의 수집 목적 및 이용]
주디항공은 서비스 제공 및 마케팅 활동을 위해 회원의 동의를 얻어 개인정보를 수집하고 있습니다.
...
나. 주디클럽 가족회원 등록 : 가족관계를 증빙할 수 있는 서류

 

[개인정보의 보유 및 이용기간]
주디항공은 회원이 주디클럽을 탈퇴하거나 자격을 상실하는 경우 또는 수집목적을 달성하거나 사업을 폐업하는 경우에는 회원DB 삭제, 문서 파기 등의 방법으로 해당 개인정보를 1일내 파기하고 있습니다. 다만, 전자상거래 등에서의 소비자보호에 관한 법률 등 관련 법령의 규정에 의하여 보존하여야 하는 기록은 일정 기간 보관 후 파기합니다. (계약 또는 청약철회 등에 관한 기록: 5년, 대금결제 및 재화 등의 공급에 관한 기록: 5년, 소비자의 불만 또는 분쟁처리에 관한 기록: 3년)
...
※ 비회원의 경우 기내면세품 전달을 위해 주디항공은 성명, 생년월일, 탑승편 정보 등 필요한 최소한의 정보만을 수집합니다.
...
[개인정보의 보유 및 이용기간]
가. 이용자가 제공한 개인정보는 주디항공이 제공하는 서비스를 받는 동안 주디항공이 보유ㆍ이용하게 됩니다.

나. 주디클럽의 개인정보의 보유 기간 및 파기 절차는 주디클럽 개인정보취급방침에 따릅니다.
...
1. 주디항공은 별도의 회원동의 없이 개인정보를 제 3자에게 제공하지 않습니다.(법률에 특별한 규정이 있는 경우 제외) 다만, 회원께서 아래의 제휴서비스 이용 시 다음의 최소한의 개인정보가 제공될 수 있습니다. >>제휴사 상세 보기

 

2. 전항의 경우를 제외하고, 회원으로부터 제공받은 개인정보를 수집 목적 이외의 용도로 이용하거나 동의없이 제3자에게 제공함으로 인해 발생하는 피해에 대하여는 주디항공에게 책임이 있습니다. 다만, 회원이 고의나 과실로 자신의 개인정보를 유출하거나 허위의 정보를 제공한 경우 또는 개인정보에 변경이 발생하였음에도 이를 알리지 않아 불일치가 발생한 경우에는 그러하지 아니합니다.
 				</textarea>
							</div>
					</div>
				</div>
