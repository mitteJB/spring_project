                    ...
                    <tr>
                        ...
                        <td>
                            <c:if test="${my.s_no eq null}">
                                <input type="button" id="btnGoCheckIn" value="체크인"
                                       onclick="goCheckIn('${my.t_no}','${my.air_name}')">
                            </c:if>
                        ...
                        <td>
                            <input type="button" value="상세보기" onclick="funcdetail('${my.t_no}')">
                        </td>
                    </tr>
